...
function N_translate_box(){
	...
	div.innerHTML='\
						...
						<div id="N_t_tool" style="display:none">\
						...
						<div style="background-color:#fff">\
							<div id="N_t_ggfy" style="display:none">\
								<div id="N_t_gglogo">\
	...
	document.getElementById('N_t_otext_CE').addEventListener('click',function(e){
		var textarea=document.getElementById('N_t_otext');
		textarea.style.display=textarea.style.display=='none'? '':'none';
		var N_t_tool=document.getElementById('N_t_tool');
		N_t_tool.style.display=N_t_tool.style.display=='none'? '':'none';
