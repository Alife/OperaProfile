...
(function(window,document){
	...
	AreaObject.prototype={
		...
		autoHeight:function(){
			var ta=this.self;
			var scrollHeight=ta.scrollHeight-this.paddingTAB;
			var curHeight=ta.clientHeight-this.paddingTAB;
			console.log("ta.scrollHeight "+ta.scrollHeight +" ta.clientHeight "+ ta.clientHeight +" this.paddingTAB "+ this.paddingTAB+" curHeight "+ curHeight);
			if(!window.opera){
