		...
		switch(elem.nodeName){
			case 'OBJECT':{
                ...
                if(/http:\/\/static\.youku\.com\//i.test(src_data)){
                    ...
                    //elem.setAttribute('data','http://git.oschina.net/kawaiiushio/antiad/raw/master/loader.swf');
                    //elem.setAttribute('data','https://github.com/yshui/antiad/raw/master/loader.swf');
                };
                if(/http:\/\/player\.youku\.com\//i.test(src_data)){
					//http://player.youku.com/player.php/sid/XNTYyODM5MjE2/v.swf
					//http://git.oschina.net/kawaiiushio/antiad/raw/master/loader.swf?VideoIDS=XNTYyODM5MjE2
                    //elem.setAttribute('data','http://git.oschina.net/kawaiiushio/antiad/raw/master/loader.swf');
                };
