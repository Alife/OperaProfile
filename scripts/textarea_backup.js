...
(function(window,document){
	...
	function init(){
		...
		function activeElem(target){
			...
			var isMatch = nodeName=='TEXTAREA' || nodeName=='INPUT';
			if(((isMatch && !target.readOnly) 
		...
		if(document.activeElement)activeElem(document.activeElement);//处理在添加focus事件之前,已经focused的对象.
