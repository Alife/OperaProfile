...
(function(){
	...
	function init(){
		...
		if(dua.length==0){
			...
			// 加载第三方播放器
			//http://opm.x.gg/flvplayer/vcastr22.swf?vcastr_file=http://f.youku.com/player/getFlvPath/sid/00_00/st/flv/fileid/03000202005187B8D28F6F0230E416AB237B8B-4D0C-7D2A-0E75-2CF3633882E3?K=8ac111e677f662e8261d3350|http://f.youku.com/player/getFlvPath/sid/00_00/st/flv/fileid/03000202015187B8D28F6F0230E416AB237B8B-4D0C-7D2A-0E75-2CF3633882E3?K=e13286be3899b5ef2828e170
			var vcastr_file = "";
			for(var i=0;i<ii;i++){
				vcastr_file+=dua[i]+"|";
			};
			...
			DurlN.style.cssText='\
				padding-right:10px;\
				font-size:13px;';
			DurlN.textContent='替换';
			//DurlN.href="http://opm.x.gg/flvplayer/vcastr22.swf?vcastr_file="+vcastr_file;
			DurlN.href="http://www.cnzz.cc/Flv/Flvplayer.swf?vcastr_file="+vcastr_file;
			body.appendChild(DurlN);
		};
	};
